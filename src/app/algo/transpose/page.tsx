      ...
      <div className="flex flex-col">
          ...
          <div className="w-full flex-1">
            <form>
              <div className="relative md-20">
                ...
                <Input
                  className="w-full shadow-none appearance-none pl-8 md:w-2/3 lg:w-1/3 rounded"
                  placeholder="Search algorythms..."
                  type="search"
                />
              </div>
            </form>
        ...
        <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-6">
          <div className="flex items-center">
            <h1 className="font-semibold text-lg md:text-2xl">Transpose Matrix</h1>
          </div>
